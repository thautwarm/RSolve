...
/* package Rcheck-0.1.0.0 */
#ifndef VERSION_Rcheck
#define VERSION_Rcheck "0.1.0.0"
#endif /* VERSION_Rcheck */
#ifndef MIN_VERSION_Rcheck
#define MIN_VERSION_Rcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Rcheck */
...
#define CURRENT_COMPONENT_ID "Rcheck-0.1.0.0-7dPoA7xmmR0B0rRABDqxQU-Rcheck"
